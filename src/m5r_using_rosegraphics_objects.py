...
#                attach_to(), move_by(), detach_from()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                fill_color(), outline_color(), outline_thickness()
#
#     f. What does a RoseWindow RENDER method do?
#            A RoseWindow render method allows for all the objects to be drawn onto the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It is always necessary because by using the close_on_mouse_click call, this allows the window to
#            stay (and remain) open (and not automatically close) until the user clicks on the window.
#
